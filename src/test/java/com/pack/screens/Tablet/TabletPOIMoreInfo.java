...
public class TabletPOIMoreInfo extends DefaultGestures {
	...
	public TabletPOIMoreInfo(AppiumDriver driver, AppiumDriver driver1) {
		super(driver);
	...
	public void readAmenities()
	{
		...
		for(int j=0; j<6;j++)
		{
			...
			try
			{
				driver1.swipe(150, 600, 150, 450, 2000);
			}
			catch(Exception e)
			{
	...
	public void verifyAmenities()
	{
		...
		{
			System.out.println(amenities_actual.get(i));
	...
	public void submitAReview(String reviewText) {
		...
		WaitForElement(ratingStars);
		TapElement(ratingStars);
		EnterText(reviewTxtBox, reviewText);
		TapElement(submitBtn);
