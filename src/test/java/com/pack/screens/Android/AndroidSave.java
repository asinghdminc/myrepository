...
public class AndroidSave extends DefaultGestures {
	...
	private By filterOption=By.xpath("//android.widget.RelativeLayout[@index='7']/android.widget.RelativeLayout[@index='0']/android.widget.CheckBox[@resource-id='com.one20.ota:id/checkBoxFilterOption']");
	...
	public void verifySortedByStartDate()
	{
		...
		for(int i=0;i<4;i++)
		{
			for(int j=0;j<6;j++)
			{
				try
				{
					String poiName=driver1.findElement(By.xpath("//android.widget.ListView[@resource-id='com.one20.ota:id/offersListView']/"
